...
<div class="container w-full h-screen flex  justify-center font-poppin">
    ...
    <div class="ml-10 lg:w-5/6  space-y-4">
        <h1 class="text-gray-600 flex justify-center text-2xl mt-10 mb-10"> Votre interface de gestion d'Utilisateurs' !</h1>
        <div class=" flex justify-between mt-60">
            <div class="flex space-x-2   ">
                <label  class=" py-2 font-semibold"  for="cin">Rechercher Utilisateur:</label>
                <input name="cin" type="text" id="cin" class="px-2 py-1 outline-none   border-2 hover:rounded-xl  rounded" placeholder="CIN">
                <button  class="px-2 py-1 rounded border-2  h-10 hover:rounded-xl hover:font-semibold text-white bg-[#4262DA]  " type="submit"><a href="rechercherUtilisateur" >Recherche</a></button>
            </div>
        </div>
        <table class="min-w-max w-full shadow-md mt-20">
            ...
            <% for (Client client : (List<Client>) request.getAttribute("UtilisateurRecherche")) {
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="py-2 px-4">
                    ...
                    <div class="flex item-center justify-center space-x-4">
                        <a class="icon-red  hover:text-xl" href="">
